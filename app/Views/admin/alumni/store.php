    ...
    <div class="row">
        ...
        <div class="col-lg-12 mb-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/alumni/store') ?>" method="post" id="triggerForm" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <div class="col-12">
        ...
        <div class="col-lg-12 mb-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/alumni/download') ?>" method="post" id="triggerForm2" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
